  ...
  <div class="row">
    <div class="col-md-12">
      <div class="profile-info">
        ...
        <div class="info-body">
          <p><strong>Room ID:</strong> <?php echo $data ['room_id']; ?> </p>
          <p><strong>Room Cat:</strong> <?php echo $data ['room_cat']; ?></p>
          <p><strong>book:</strong> <?php echo $data ['book']; ?></p>
          <p><strong>persons:</strong> <?php echo $data ['persons']; ?></p>
    ...
    <div class="col-md-12">
      <div class="address-info">
        ...
        <div class="info-body">
          <p><strong>checkin:</strong> <?php echo $data ['checkin']; ?></p>
          <p><strong>checkout:</strong> <?php echo $data ['checkout']; ?></p>
          <p><strong>checkin_ampm:</strong> <?php echo $data ['checkin_ampm']; ?></p>
          <p><strong>checkout_ampm:</strong><?php echo $data ['checkout_ampm']; ?></p>
...
<div class="modal fade" id="updateAccountInfoModal" tabindex="-1" role="dialog" aria-labelledby="updateAccountInfoModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <h5 class="modal-title" id="updateAccountInfoModalLabel">Update Reservation Information</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>

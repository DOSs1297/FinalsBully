<?php
   ...
   FROM rooms WHERE (checkin <= '$checkin' AND checkout >='$checkout') OR (checkin >= '$checkin' AND checkin <='$checkout') OR (checkin <= '$checkin' AND checkout >='$checkin') )";
            ...
            public function booknow($checkin, $checkout, $name, $phone,$roomname, $persons)
            {
   ...
   FROM rooms WHERE checkin <= '$checkin' AND checkout >='$checkout'))";
                    ...
                    if(mysqli_num_rows($check) == 0)
                    {
                        ...
                        $sql2="INSERT rooms  SET checkin_ampm='$checkin', checkout_ampm='$checkout', persons='$persons', name='$name', phone='$phone', book='true' WHERE room_id=$id";
